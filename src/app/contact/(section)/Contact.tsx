...
const Contact = ({}) => {
  ...
  return (
    <section
      className="flex h-full w-full flex-col items-center justify-center bg-[#317299]"
      id="contact"
    >
      <div className="flex h-full w-full max-w-[1300px] flex-col gap-[2.5rem] px-0 py-12 pl-0 md:px-2 md:py-24">
        <div className="flex w-full flex-col lg:flex-row">
          <div className="flex w-full flex-col gap-8 bg-[#317299] px-6 lg:w-1/2 lg:px-28">
            <div className="flex flex-col gap-8">
              <p className="font-bai text-lg leading-[4px] text-[#F7F4ED]">
                Contact Us
              </p>
              <h1 className="font-forum text-4xl font-medium uppercase leading-[50px] tracking-[5px] text-[#F7F4ED] lg:text-5xl">
                Get in
                <br /> Touch
              </h1>
            </div>
            <div className="flex flex-col gap-8">
              <div className="flex gap-6">
                <div>
                  <div className="h-fit w-fit rounded-full p-2">
                    <MapPin className="text-[#F7F4ED]" />
                  </div>
                </div>
                <div className="flex flex-col gap-4">
                  <Link href={"https://g.co/kgs/1gWhtT5"} target="_blank">
                    <p className="text-[#F7F4ED]">
                      7 Enfield Rd, London N1 5EN,
                      <br /> United Kingdom
                    </p>
                  </Link>
                  <Link href={"https://g.co/kgs/1gWhtT5"} target="_blank">
                    <p className="flex items-center gap-2 text-sm text-[#F7F4ED]">
                      <span>Get Direction</span>
                      <ArrowRight className="text-[#F7F4ED]" />
                    </p>
                  </Link>
                </div>
              </div>
              ...
              <div className="flex items-center gap-6">
                <div>
                  <div className="h-fit w-fit rounded-full p-2">
                    <Phone className="text-[#F7F4ED]" />
                  </div>
                </div>
                <div className="flex flex-col gap-4">
                  <Link href="tel:+442079230047" className="text-[#F7F4ED]">
                    +442079230047
                  </Link>
                </div>
              </div>
              <div className="flex items-center justify-start gap-4">
                <Link
                  ...
                  target="_blank"
                >
                  <Icons.instagram className="text-[#F7F4ED]" />
                </Link>
                <Link
                  href={
                  ...
                  target="_blank"
                >
                  <Icons.unknown className="text-[#F7F4ED]" />
                </Link>
                <Link href={"https://g.co/kgs/1gWhtT5"} target="_blank">
                  <Icons.google className="text-[#F7F4ED]" />
                </Link>
          ...
          <div className="flex w-full flex-col bg-[#317299] lg:w-1/2 lg:items-center lg:justify-center">
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="h-full">
                  <div className="flex gap-4 pt-7">
                    <div className="flex w-full flex-col gap-6">
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem className="w-full">
                            <FormLabel className="text-[#F7F4ED]">
                  ...
                  <div className="flex w-full flex-col pt-7 lg:flex-row">
                    <Button
                      className="font-bai w-full rounded-2xl bg-[#F7F4ED] py-6 hover:bg-secondary"
